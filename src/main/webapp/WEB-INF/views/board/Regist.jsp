          ...
          $("#signupbtn")
               .on(
                     ...
                     function() {
                        ...
                        var divEmailCheck = $(".emailCheck.regex").text();
                           ...
                           if (nameregex == null || div1 != "사용가능") {
                              ...
                              if (emailregex == null
                                 ...
                                 return;
                                    ...
                                    /* if(emailNumCheck != true){
                                    $("#errorMsg").show();
                                    $("#errorMsg")
                                          .html( "인증번호 전송버튼을 누르시오. ex:181818");
                                    return;
                                    }else if(emailNumCheck == true){
                                       
                                       if(divEmailCheck == ""){
                                          $("#errorMsg").show();
                                          $("#errorMsg")
                                                .html( "인증번호를 입력하시오. ex:181818");
                                          return;
                                       }else if(divEmailCheck != ""){
                                          if(divEmailCheck == "인증번호를 다시 눈닦고 확인해주세요."){
                                             $("#errorMsg").show();
                                             $("#errorMsg")
                                                   .html( "인증번호를 다시 확인해주세요.ex:181818");
