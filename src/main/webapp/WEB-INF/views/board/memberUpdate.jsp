...
<body>
	...
	<form action="/memberUpdate" method="post">
		...
		회원아이디 : <input type="text" name="user_id" value="${dto.user_id}"><br> 
		...
		회원이메일수신여부 : <input type="checkbox" name="email_check" value="1"<c:if test="${dto.email_check}"> checked</c:if>> <br> 
...
<body>
	...
	<div class="page">
		...
		<form role="form" method="post" action="/memberUpdate" id="signform">
			<input type="hidden" name="user_no" value="${dto.user_no}">
			<h1 class="mainText">회원 정보 수정</h1>
			<p class="mainText2">회원정보를 입력하여 수정하십시오</p>
			...
			<div class="inputTag">
				...
				<div class="form-box">
					...
					<input type="text" name="user_id" id="id" value="${dto.user_id}"
						class="input-ty" placeholder="아이디" autofocus="" />
					...
					<input type="text" style="ime-mode:disabled" name="user_nick" value="${dto.user_nick}"
						id="name" class="input-ty1" placeholder="닉네임" />
					<div class="name regex"></div>


					<input type="number" name="user_phone" value="${dto.user_phone}"
						id="phone" class="input-ty1" placeholder="폰 번호" />
					<div class="phone regex"></div>


					<input type="email" name="user_email" value="${dto.user_email}"
						id="email" class="input-ty1" placeholder="이메일" />
					...
					<div class="checkDiv">
						<span class="checkBoxText">당신은 성인입니까?</span> <input
							type="checkbox" class="checkBox" name="user_adult"
							id="user_adult" value="1"
							<c:if test="${dto.user_adult}"> checked</c:if>> <br>
						<span class="checkBoxText">이메일 수신에 동의하십니까? </span> <input
							type="checkbox" class="checkBox" name="email_check"
							id="email_check" value="1"
							<c:if test="${dto.email_check}"> checked</c:if>>
					</div>
				</div>
